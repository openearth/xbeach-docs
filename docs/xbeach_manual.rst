...
When the keyword :par:`order` is set to 2, the second order bound waves are included in the boundary. 
...
These bound waves are generated by a pair of primairy waves or the self-interaction of a single primairy wave. 
Thus, when a spectrum is forced at the boundary, the wave interactions for every component are computed. 

The radial frequency and wave number of this bound wave are given by,
